...
<m-navbar :theme="theme.theme.headerTheme">
  ...
  <m-nav>
    <m-nav-item><a href="http://localhost:8080" target="_blank">HomePage</a></m-nav-item>
    <m-nav-item><a href="https://github.com/hushifeng/portfolioManager" target="_blank">Github</a></m-nav-item>
    <m-nav-item><a href="https://github.com/hushifeng" target="_blank">About</a></m-nav-item>
  </m-nav>
  <m-nav align="right">
    ...
    <m-nav-item padding="0">
      <m-dropdown align="right" v-if="user" padding="0 10px">
        ...
        <m-dropdown-panel>
          <m-dropdown-item disabled>UserInfo</m-dropdown-item>
          <m-dropdown-item disabled>changePassword</m-dropdown-item>
          <m-dropdown-item disabled>Shutdown</m-dropdown-item>
          <div class="test-line"></div>
          <m-dropdown-item name="login">Sign out</m-dropdown-item>
        </m-dropdown-panel>
      </m-dropdown>
    </m-nav-item>
...
export default {
  ...
  methods: {
    ...
    handleSwitchSide () {
      console.log('hhhhhhhhhhhssssssssssfffffff')
      this.mini = !this.mini
    ...
    handleSwitchHideSide () {
      console.log('llllllllllqqqqqqqqq')
      this.$emit('hide-side')
    }
  },
  created () {
