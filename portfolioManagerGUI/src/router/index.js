  ...
  routes: [
    {
      ...
      children: [
        ...
        //my design pages
        {path: '/reports', name: 'reports', component: page('reports')},
        {path: '/fundManagerInfo', name: 'fundManagerInfo', component: page('fundManagerInfo')},
        {path: '/transferPortfolio', name: 'transferPortfolio', component: page('transferPortfolio')},
        {path: '/uploadPrices', name: 'uploadPrices', component: page('uploadPrices')},
        {path: '/uploadRates', name: 'uploadRates', component: page('uploadRates')},
        //my design pages for manager
        {path: '/positions', name: 'positions', component: page('positions')},
        {path: '/portfolios', name: 'portfolios', component: page('portfolios')}
      ]
    },
